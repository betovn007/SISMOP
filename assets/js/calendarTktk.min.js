...
function(t) {
    ...
    var e = {
            ...
            i18n: {
                ...
                weekdays: ["Dormingo", "Gluglunes", "Martinis", "Miercolitros", "Juebebes", "Viernebrios", "Sabadrink"],
            ...
            return _inherits(n, Component), _createClass(n, [{
                ...
                value: function() {
                    var t = n._isDate(this.date) ? this.date : new Date,
                        ...
                        o = t.getDate();
                    this.yearTextEl.innerHTML = t.getFullYear(), this.dateTextEl.innerHTML = i + " " + o + " de " + s
                }
            }, {
                key: "gotoDate",
                value: function(t) {
